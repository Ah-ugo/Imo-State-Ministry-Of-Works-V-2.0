...
export default function AddBlog() {
  ...
  const SubmitBlog = () => {
    setLoading(true);
    const PARSE_APPLICATION_ID = "csobjLY2bE8OHm3T1bz4djAMkGArnKzSN3BzTH2m";
    const PARSE_HOST_URL = "https://parseapi.back4app.com/";
    const PARSE_JAVASCRIPT_KEY = "Kh5JZM4u4rL4aGR9yW6TPpluODGsd0TstFGAKOs1";
    const PARSE_REST_KEY = "9asz5jYuIJvo8r5j84ZZnoQOLTf5foY14y5ONubz";
    ...
    Project.save({
      ...
      .then((res) => {
        ...
        navigate("/blog"); // Redirect to the "/blog" route after successful submission.
      })
      .catch((error) => {
